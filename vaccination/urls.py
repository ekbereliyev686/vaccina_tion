...
urlpatterns = [
        ...
        path('certificate-vaccination/<int:vaccination_id>/',views.vaccination_certificate,name='certificate-vaccination'),
        path('approve-vacccination/<int:vaccination_id>/',views.approve_vaccination,name ='approve-vaccination'),
